...
public class Validation
{
    internal static bool ValidateId(string userInput)
    {
        ...
        if (parsedId == false) return false;
        int lastId = 0;
    ...
    internal static DateTime ValidateStartTime(string startTime)
    {
        ...
        while (parsed == false)
        {
            ...
            startTime = AnsiConsole.Ask<string>("Enter the time you started your shift(format: HH:mm): ");
    ...
    internal static DateTime ValidateEndTime(string endTime, DateTime startTime)
    {
        ...
        {
            Console.WriteLine("Invalid starting time.");
            endTime = AnsiConsole.Ask<string>("Enter the time you ended your shift(format: HH:mm): ");
